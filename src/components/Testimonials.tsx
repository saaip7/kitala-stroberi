  ...
  return (
    <section className="py-12 md:py-16">
      <div className="mx-auto">
        {/* Header */}
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-12 gap-6 md:gap-0" style={{ paddingLeft: '2vw', paddingRight: '2vw' }} data-aos="fade-up">
