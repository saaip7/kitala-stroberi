  ...
  return (
    <div className="min-h-screen py-2">
      <div className=" mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative rounded-3xl overflow-hidden min-h-[95vh] bg-white">
          {/* Background Image */}
            ...
            <div className="w-full px-8 lg:px-12 ">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
                ...
                <div className="lg:col-span-7 text-white">
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold mb-6 font-sans ">
                    Petik Buahnya
                    <br />
                    Bantu Tumbuh
                    <br />
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <button className="bg-white hover:bg-gray-100 text-black px-6 py-3 rounded-full flex items-center justify-center gap-3 transition-all duration-200 font-medium text-md group shadow-lg">
                      KUNJUNGI KAMI
                    ...
                    <button className="bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white px-8 py-3 rounded-full transition-all duration-200 font-medium text-md border border-white/30">
                      HUBUNGI
                    </button>
                  </div>
                </div>
                ...
                <div className="lg:col-span-5 lg:flex lg:justify-end flex-col items-end">
